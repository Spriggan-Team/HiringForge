...
class AccountChecker extends UserCheckerInterface {
    ...
    public function checkPreAuth(UserInterface $user): void
    {
        ...
        {
            throw new CustomUserMessageAccountStatusException("Something wrong happened while checking for authenticated user");
        }
    }
