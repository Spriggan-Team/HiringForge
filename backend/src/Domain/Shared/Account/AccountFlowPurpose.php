 ...
 * Defines why an OTP or a verification token is issued (e.g., password reset,
...
{
    case PASSWORD_RESET = "PASSWORD_RESET";     // Defines reset password
    case EMAIL_CHANGE = "EMAIL_CHANGE";         // Defines change context on email
    case SIGN_UP = "SIGNUP";                    // USED for signup
    case LOGIN_WARNING = "LOGIN_WARNING";       // Used for login warning (ex: unauthorized user)

    case CONFIRM_AGENT_IDENTITY = "CONFIRM_AGENT"; //use to confirm the identity of an agent
    case AUTHENTIFICATION_ACCESS = "AUTHENTIFICATION_ACCESS"; //-- auth token
